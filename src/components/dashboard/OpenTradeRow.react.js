...
class OpenTradeRow extends Component {
  ...
  render() {
    return (
      <div id="ot-list-row" onClick={() => this.props.handleClick(this.props.tradeId)}>
        <p id="at-ticker">{this.props.ticker}</p>
        ...
        <p id="at-profit-loss-pct" style={{color: this.props.profitLossPct > 0 ? "green" : this.props.profitLossPct === 0 ? "black" : "rgb(211, 63, 73)"}} >
          {this.formatPct(this.props.profitLossPct)}
        </p>
        <div id="at-figure">
